...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AGeometrySandboxGameModeBase()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AGeometrySandboxGameModeBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AGeometrySandboxGameModeBase, 143023661);
